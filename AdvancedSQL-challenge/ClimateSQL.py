...
def home():
    ...
    return (
        ...
        f"Dates and precipitation observations from last year<br/><br/>"
        ...
        f"List of `TMIN`, `TAVG`, and `TMAX` for dates between the start and end date inclusive<br/><br/>"
        )
...
def stations():
    ...
    station_l = {item.station: item.name for item in station_r}
